...
> Generado por `scripts/status.mjs` el 2026-08-20 17:05. **No editar a mano** (se regenera). Fuente: `queue/`, `posted/posted.jsonl`, `src/content/blog/`, `ROADMAP.md`, `video/projects/`.
